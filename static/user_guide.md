...
- [User Guide](#user-guide)
	...
	- [3 Usage Overview](#3-usage-overview)
		- [Basics](#basics)
		- [Construct Business Repository](#construct-business-repository)
	...
	- [5 Extended Usage Annotations](#5-extended-usage-annotations)
		- [@InitializeData](#initializedata)
		- [@CustomType](#customtype)
		- [@AutoGenerated](#autogenerated)
		- [@ConditionBean](#conditionbean)
	- [6. Package Scanning Functionality](#6-package-scanning-functionality)
...
The Repository can be directly obtained via the SQLQueryFactory object.
...
## 6. Package Scanning Functionality

The package scanning feature is generally configured during system initialization and is used for executing automatic database operation tasks. It also completes the pre-loading of some custom annotations.
...
* Creates an initialization configuration table in the database to control whether to modify or merge data in this table in the future.
...
All of these features come with multiple control switches to prevent accidental deletion of tables or columns, which could result in data loss.

**Disable DDL**

Although the framework uses Online methods to modify existing database tables, there is still a possibility that executing DDL might lock tables. In high-load production environments with particularly high availability requirements, it is recommended to disable the feature of executing DDL during startup. 

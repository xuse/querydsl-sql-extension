...
* 在各种各样针对数据库访问的Query API中，在QueryDSL是最友好的QueryBuilder之一。
...
* 【关于灵活性】某些企业认为员工技术能力不足，又缺乏技术规范和管理手段制约，所以宁可选择功能不灵活的框架。这代表了另一类思想体系和评价标准，所有querydsl体系的框架都不适合这类企业使用，本人对此不予置评。

## 一点感想

这个框架可以说是无心偶得，今后也会佛系维护。
本框架的使用建议是取代JPA，如果是JPA的补充，那么Spring-data和querydsl-jpa已经做得很好，没有画蛇添足的必要。实际上我本人也是从JPA路线转换过来，过程大概经历了这样几步：

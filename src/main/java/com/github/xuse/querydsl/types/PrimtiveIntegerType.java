 ...
 *
 */
public class PrimtiveIntegerType extends AbstractType<Integer> {
	
	public static final PrimtiveIntegerType INSTANCE=new PrimtiveIntegerType();

    public PrimtiveIntegerType() {
        super(Types.INTEGER);
    }

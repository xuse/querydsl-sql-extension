...
//			addMetadata(created, ColumnMetadata.named("CREATED").withIndex(3).ofType(Types.TIMESTAMP).withSize(29).withDigits(9));
	...
	@Override
	public ColumnMapping withUnsavePredicate(String expression) {
		this.unsavedValue= UnsavedValuePredicateFactory.create(field.getType(), expression);
		return this;
	}
	 ...
	 * @param params
	 */
	public ColumnMapping withAutoGenerate(GeneratedType type,boolean overwite,String... params) {
		this.generated = new AutoGeneratedImpl(type,overwite,params);
		return this;
	}
	
	static class AutoGeneratedImpl implements AutoGenerated{
		private final GeneratedType type;
		private final boolean overwrite;
		private final String[] params;
		AutoGeneratedImpl(GeneratedType type,boolean overwrite,String[] params) {
			this.type=type;

...
public class DDLExpressions {
	...
	public static Expression<?> dataType(String dataType, boolean isNullable, boolean unsigned,
		...
		Expression<?> defaultExp = defaultValue == null ? EMPTY
				: simple(DDLOps.DEFAULT, defaultValue);
	 ...
	 * @return expression
	 */
	public static Expression<?> constraintDefinition(ConstraintType type, RelationalPath<?> table, SchemaAndTable constraintName,

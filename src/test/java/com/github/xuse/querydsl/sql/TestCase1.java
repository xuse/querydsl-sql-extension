...
//			st.executeUpdate(
//					"create table aaa(id int generated by default as identity, name varchar(64), created timestamp, gender varchar(8),"
//							+ "PRIMARY KEY (id))");
...
//					+ ")");
			...
			st.executeUpdate(
					"create table aaa(id int AUTO_INCREMENT not null, name varchar(64), created timestamp, gender varchar(8),"
							+ "PRIMARY KEY (id))");
			st.executeUpdate("CREATE TABLE avs_user_authority (\r\n"
...
//		a.setId(1);
		...
		int id = factory.insert(t2).set(t2.authContent, "abcdefg").set(t2.devId, "123")

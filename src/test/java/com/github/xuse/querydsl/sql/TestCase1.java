...
//		}
	...
	public ConfigurationEx querydslConfiguration(SQLTemplates templates) {
		...
		configuration.addListener(new QueryDSLSQLListener(2));
...
//		System.out.println(num);
	...
	public void testUpdateBatch() {
		QAaa t1 = QAaa.aaa;
		long count=factory.update(t1).where(t1.name.eq("1")).set(t1.version, t1.version.add(1)).addBatch().where(t1.name.eq("2")).set(t1.version, t1.version.add(2)).addBatch().execute();
	...
	public void testDeleteBatch() {
		QAaa t1 = QAaa.aaa;
		long count=factory.delete(t1).where(t1.name.eq("1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")).addBatch().where(t1.name.eq("2")).addBatch().execute();
		System.out.println(count);
	}
...
//		p.setCreateTime(new Date[] {new Date(0),new Date()});
	...
	public void testCalc() {
		...
		double ff = 111.5*13/31+111.5*0.05*15/31+111.5*0.5*3/31;

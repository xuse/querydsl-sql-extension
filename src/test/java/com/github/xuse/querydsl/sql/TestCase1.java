...
//		}
	}
	{
		...
		factory = new SQLQueryFactory(querydslConfiguration(SQLQueryFactory.calcSQLTemplate(ds.getUrl())),ds, false);
	}
	...
	public ConfigurationEx querydslConfiguration(SQLTemplates templates) {
		...
		configuration.checkRegister(QAvsUserAuthority.avsUserAuthority);
	...
	public void reCreateTable() throws SQLException {
		...
		try (Statement st = conn.createStatement()) {
			...
			if(factory.getConfiguration().getTemplates() instanceof MySQLTemplates) {
				...
				st.executeUpdate(
				"create table aaa(id int generated by default as identity, name varchar(64), "
				+ "created timestamp, "
				+ "gender int,"
				+"version int,"
				+ "task_status int,"
...
//		a.setId(1);
		...
		String sid = factory.insert(t2).set(t2.authContent, "abcdefg").set(t2.devId, "123")

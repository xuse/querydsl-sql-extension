...
public class QSeataStateMachineInst extends RelationalPathBaseEx<SeataStateMachineInst> {
    ...
    public void addMetadata() {
        ...
        addMetadata(endParams, ColumnMetadata.named("end_params").withIndex(10).ofType(Types.LONGVARCHAR).withSize(65535));
        addMetadata(excep, ColumnMetadata.named("excep").withIndex(9).ofType(Types.LONGVARBINARY).withSize(65535));
        ...
        addMetadata(startParams, ColumnMetadata.named("start_params").withIndex(7).ofType(Types.LONGVARCHAR).withSize(65535));

...
abstract class AbstractR2ResultSet extends UnsupportedJdbcResultSet {
	...
	public Date getDate(int columnIndex) {
		return  DateUtils.toSqlDate(row.get(columnIndex-1, LocalDate.class));
	}
	
	public Date getDate(String columnName) {
		return DateUtils.toSqlDate(row.get(columnName, LocalDate.class));
	}
	...
	public Date getDate(String columnLabel, Calendar cal) {
		return DateUtils.toSqlDate(row.get(columnLabel,LocalDate.class)) ;
	}

	@Override
	public Time getTime(int columnIndex, Calendar cal) {
		return DateUtils.toSqlTime(row.get(columnIndex-1,LocalTime.class));
	}

	@Override
	public Time getTime(String columnLabel, Calendar cal) {
		return DateUtils.toSqlTime(row.get(columnLabel,LocalTime.class));
	}
	...
	public Time getTime(String columnName) {
		return DateUtils.toSqlTime(row.get(columnName, LocalTime.class));
	}

	public Timestamp getTimestamp(String columnName) {
		return DateUtils.toSqlTimeStamp(row.get(columnName, LocalDateTime.class));
	}
	
	public Timestamp getTimestamp(int columnIndex) {
		return DateUtils.toSqlTimeStamp(row.get(columnIndex-1, LocalDateTime.class)) ;
	}
	...
	public Timestamp getTimestamp(String columnLabel, Calendar cal) {
		return DateUtils.toSqlTimeStamp(row.get(columnLabel,LocalDateTime.class));
	}

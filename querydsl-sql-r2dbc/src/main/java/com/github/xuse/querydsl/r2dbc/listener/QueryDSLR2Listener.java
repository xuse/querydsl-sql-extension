...
public final class QueryDSLR2Listener implements R2BaseListener {
	...
	@Override
	public final void start(R2ListenerContext context) {
	}

	@Override
	public final void preRender(R2ListenerContext context) {
	}

	@Override
	public final void rendered(R2ListenerContext context) {
	}

	@Override
	public final void prePrepare(R2ListenerContext context) {
	}
	 ...
	 * </ul>
	 */
	public QueryDSLR2Listener(int format) {
	 ...
	 */
	public QueryDSLR2Listener(int format, int maxBatchCount) {
		switch(format) {
			case FORMAT_COMPACT:
	...
	@Override
	public final void preExecute(R2ListenerContext context) {
	...
	@Override
	public final void prepared(R2ListenerContext context) {
	}

	@Override
	public final void exception(R2ListenerContext context) {
		log.error(errorFormatter.format(context.getAllSQLBindings()), context.getException());
	}

	@Override
	public final void end(R2ListenerContext context) {
	}
}

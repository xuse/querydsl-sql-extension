...
public class DbSchemaGenerator {
	...
	/**
	 * 生成类是否实现{@link Serializable}接口
	 * @param flag true/false
	 * @return this
	 */
	public DbSchemaGenerator serializable(boolean flag) {
		this.serializable=flag;
		return this;
	}
	...
	private Pair<File, Boolean> generateTable(TableInfo table) {
		...
		if(serializable) {
			targetClz.setImplementedTypes(NodeList.nodeList(cu.createClassType(Serializable.class)));
		}

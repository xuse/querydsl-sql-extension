 ...
 */
@Data
@TableSpec(name = "ca_foo", primaryKeys = "id", collate = "utf8mb4_general_ci", keys = { @Key(path = { "code" }, type = ConstraintType.UNIQUE), @Key(path = { "content" }, type = ConstraintType.FULLTEXT, allowIgnore = true) })
...
public class Foo implements Serializable {
    ...
    public static final SimpleLambdaColumn<Foo, Map<String, String>> _ext = Foo::getExt;

    public static final BooleanLambdaColumn<Foo> _init = Foo::getInit;
}

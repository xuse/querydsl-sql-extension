...
public enum GeneratedType {
	 ...
	 * 参见 {@link com.github.xuse.querydsl.config.ConfigurationEx#initSnowflake(int, int)}
	 ...
	 * cannot be used.
	 * See {@link com.github.xuse.querydsl.config.ConfigurationEx#initSnowflake(int, int)}

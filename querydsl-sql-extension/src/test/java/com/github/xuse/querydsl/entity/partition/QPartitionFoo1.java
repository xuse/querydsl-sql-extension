...
public class QPartitionFoo1 extends RelationalPathBaseEx<PartitionFoo1> {
	private static final long serialVersionUID = -1972906214968601009L;

	public static final QPartitionFoo1 partitionFoo1 = new QPartitionFoo1("pf1");
	...
	public QPartitionFoo1(String variable) {
		super(PartitionFoo1.class, variable);
		scanClassMetadata();
	}
}

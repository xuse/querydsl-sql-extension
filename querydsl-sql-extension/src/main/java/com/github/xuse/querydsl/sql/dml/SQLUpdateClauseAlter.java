...
public class SQLUpdateClauseAlter extends AbstractSQLUpdateClause<SQLUpdateClauseAlter> {
	...
	public SQLUpdateClauseAlter populateWithCompare(Object bean, Object old) {
		...
		return populateWithCompare0(wrapIfNeeded(bean), old == null ? null : wrapIfNeeded(old), mapper, false);
	}
	...
	public SQLUpdateClauseAlter populateWithCompare(Object bean, Object old, boolean pkAsWhere) {
		Mapper<?> mapper = Mappers.getNormal(false, updateNulls);
		return populateWithCompare0(wrapIfNeeded(bean), old == null ? null : wrapIfNeeded(old), mapper, pkAsWhere);
	}

	/**
	 * @deprecated Since Mapper is not an proper object for user.
	 */
	@Deprecated
	public SQLUpdateClauseAlter populateWithCompare(Object bean, Object old, Mapper mapper, boolean fillPkAsWhere) {
		return populateWithCompare0(bean,old,mapper,fillPkAsWhere);
	}
	
	@SuppressWarnings({ "unchecked", "rawtypes" })
	private SQLUpdateClauseAlter populateWithCompare0(Object bean, Object old, Mapper mapper, boolean fillPkAsWhere) {

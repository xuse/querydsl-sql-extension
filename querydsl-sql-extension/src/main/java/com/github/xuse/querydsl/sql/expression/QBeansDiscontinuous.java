 ...
 * @author Joey
 */
public class QBeansDiscontinuous extends DiscontinuousFieldBeans<Beans> {

    private static final long serialVersionUID = -4411839816134215923L;
    
	public QBeansDiscontinuous(List<Expression<?>> expressions, Map<RelationalPath<?>, QValuesBuildBean> beans) {
		super(Beans.class,expressions,beans);
	}
	...
	public static class Builder{
		...
		public QBeansDiscontinuous build() {
			return new QBeansDiscontinuous(exprs, qBeans);
		}
	}

...
/**
 * 提供和{@link java.util.List}接口相同的功能，但是免去了long类型的装箱和拆箱，从而得到性能上的改善。
...
public final class LongList {
	 ...
	 * @param o long
	 *
	 * @throws ClassCastException If encounter ClassCastException
	 * @throws NullPointerException If encounter NullPointerException
	 * @return index
	 */

...
public class MBeanRegistration {
    ...
    /**
     * @param mBean
     *            an MBean instance in the form of a traditional MBean (implementing a sibling
     *            *MBean interface) or an MXBean (implementing an interface annotated with
     *            {@code @MXBean}), or an instance implementing the DynamicMBean interface.
    ...
    public void register() throws ManagementException {
        try {
            DynamicMBean dynamicMBean = new IntrospectedMBean(mBean);

...
public class ChineseNumberReaderTest {
	...
	public void testCurrency() {
		...
		assertEquals("拾贰萬叁仟肆佰伍拾陆元整", ChineseNumberReader.CURRENCE.forNumber(123456));
		...
		assertEquals("拾亿零叁仟肆佰零陆萬柒仟捌佰玖拾贰元整", ChineseNumberReader.CURRENCE.forNumber(1034067892));
		assertEquals("拾贰亿叁仟肆佰伍拾陆萬柒仟捌佰玖拾元整", ChineseNumberReader.CURRENCE.forNumber(1234567890));
		assertEquals("拾萬零叁仟叁佰肆拾亿零玖萬元整", ChineseNumberReader.CURRENCE.forNumber(10_3340_0009_0000L));
		assertEquals("壹萬亿元整", ChineseNumberReader.CURRENCE.forNumber(1_0000_0000_0000L));
		assertEquals("拾萬亿元整", ChineseNumberReader.CURRENCE.forNumber(10_0000_0000_0000L));

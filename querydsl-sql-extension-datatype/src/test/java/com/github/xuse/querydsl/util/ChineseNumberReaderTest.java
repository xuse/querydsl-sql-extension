...
public class ChineseNumberReaderTest {
	...
	public void testFiance() {
		...
		assertEquals("负玖拾玖萬玖仟玖佰玖拾玖", ChineseNumberReader.FINANCE.forNumber(-999999));
		...
		assertEquals("壹萬", ChineseNumberReader.FINANCE.forNumber(10000));
		assertEquals("壹萬零壹", ChineseNumberReader.FINANCE.forNumber(10001));
		assertEquals("壹萬零壹佰零壹", ChineseNumberReader.FINANCE.forNumber(10101));
		assertEquals("壹萬零壹佰壹拾壹", ChineseNumberReader.FINANCE.forNumber(10111));
		assertEquals("壹萬壹仟壹佰零壹", ChineseNumberReader.FINANCE.forNumber(11101));
		assertEquals("壹萬壹仟壹佰壹拾壹", ChineseNumberReader.FINANCE.forNumber(11111));
		assertEquals("拾贰萬叁仟肆佰伍拾陆", ChineseNumberReader.FINANCE.forNumber(123456));
		assertEquals("壹亿贰仟叁佰肆拾萬", ChineseNumberReader.FINANCE.forNumber(1_2340_0000)); 
		assertEquals("壹亿贰仟叁佰肆拾伍萬", ChineseNumberReader.FINANCE.forNumber(1_2345_0000));
		...
		assertEquals("拾亿零叁仟肆佰零陆萬柒仟捌佰玖拾贰", ChineseNumberReader.FINANCE.forNumber(1034067892));
		assertEquals("拾贰亿叁仟肆佰伍拾陆萬柒仟捌佰玖拾", ChineseNumberReader.FINANCE.forNumber(1234567890));
		assertEquals("拾萬零叁仟叁佰肆拾亿零玖萬", ChineseNumberReader.FINANCE.forNumber(10_3340_0009_0000L));
		assertEquals("壹萬亿", ChineseNumberReader.FINANCE.forNumber(1_0000_0000_0000L));
		assertEquals("拾萬亿", ChineseNumberReader.FINANCE.forNumber(10_0000_0000_0000L));
	...
	public void testCurrency() {
		...
		assertEquals("负玖拾玖萬玖仟玖佰玖拾玖元整", ChineseNumberReader.CURRENCE.forNumber(-999999));
		assertEquals("零元整", ChineseNumberReader.CURRENCE.forNumber(0));
		assertEquals("玖元整", ChineseNumberReader.CURRENCE.forNumber(9));
		assertEquals("壹拾元整", ChineseNumberReader.CURRENCE.forNumber(10));
		assertEquals("壹拾壹元整", ChineseNumberReader.CURRENCE.forNumber(11));
		assertEquals("壹拾柒元整", ChineseNumberReader.CURRENCE.forNumber(17));
		...
		assertEquals("壹萬元整", ChineseNumberReader.CURRENCE.forNumber(10000));
		assertEquals("壹萬零壹元整", ChineseNumberReader.CURRENCE.forNumber(10001));
		assertEquals("壹萬零壹佰零壹元整", ChineseNumberReader.CURRENCE.forNumber(10101));
		assertEquals("壹萬零壹佰壹拾壹元整", ChineseNumberReader.CURRENCE.forNumber(10111));
		assertEquals("壹萬壹仟壹佰零壹元整", ChineseNumberReader.CURRENCE.forNumber(11101));
		assertEquals("壹萬壹仟壹佰壹拾壹元整", ChineseNumberReader.CURRENCE.forNumber(11111));
		assertEquals("壹拾贰萬叁仟肆佰伍拾陆元整", ChineseNumberReader.CURRENCE.forNumber(123456));
		assertEquals("壹亿贰仟叁佰肆拾萬元整", ChineseNumberReader.CURRENCE.forNumber(1_2340_0000)); 
		assertEquals("壹亿贰仟叁佰肆拾伍萬元整", ChineseNumberReader.CURRENCE.forNumber(1_2345_0000));
		assertEquals("壹拾亿元整", ChineseNumberReader.CURRENCE.forNumber(1000000000));
		assertEquals("壹拾亿零壹元整", ChineseNumberReader.CURRENCE.forNumber(1000000001));
		assertEquals("壹拾亿零伍仟元整", ChineseNumberReader.CURRENCE.forNumber(1000005000));
		assertEquals("壹拾亿零伍仟零壹元整", ChineseNumberReader.CURRENCE.forNumber(1000005001));
		assertEquals("壹拾亿零叁仟肆佰零陆萬柒仟捌佰玖拾贰元整", ChineseNumberReader.CURRENCE.forNumber(1034067892));
		assertEquals("壹拾贰亿叁仟肆佰伍拾陆萬柒仟捌佰玖拾元整", ChineseNumberReader.CURRENCE.forNumber(1234567890));
		assertEquals("壹拾萬零叁仟叁佰肆拾亿零玖萬元整", ChineseNumberReader.CURRENCE.forNumber(10_3340_0009_0000L));
		assertEquals("壹萬亿元整", ChineseNumberReader.CURRENCE.forNumber(1_0000_0000_0000L));
		assertEquals("壹拾萬亿元整", ChineseNumberReader.CURRENCE.forNumber(10_0000_0000_0000L));
		assertEquals("零元整", ChineseNumberReader.CURRENCE.forDouble(0d));
		assertEquals("壹拾元叁角捌分", ChineseNumberReader.CURRENCE.forDouble(10.38));
